  ...
  <div className="container mx-auto px-4">
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      <div className="flex items-center justify-center gap-4 p-6 bg-white rounded-xl shadow-sm">
        <Monitor className="h-10 w-10 text-blue-500" /> {/* Adjusted size */}
        <div className="text-center"> {/* Centered the text */}
          <h3 className="font-semibold text-lg">Web Development</h3> {/* Adjusted text size */}
        </div>
      </div>
      <div className="flex items-center justify-center gap-4 p-6 bg-white rounded-xl shadow-sm">
        <Palette className="h-10 w-10 text-purple-500" /> {/* Adjusted size */}
        <div className="text-center"> {/* Centered the text */}
          <h3 className="font-semibold text-lg">User Experience</h3> {/* Adjusted text size */}
        </div>
      </div>
      <div className="flex items-center justify-center gap-4 p-6 bg-white rounded-xl shadow-sm">
        <Database className="h-10 w-10 text-green-500" /> {/* Adjusted size */}
        <div className="text-center"> {/* Centered the text */}
          <h3 className="font-semibold text-lg">Marketing</h3> {/* Adjusted text size */}
        </div>
      </div>
    </div>
  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-12 space-y-24">
          {/* Join Us Section - Image Right, Text Left */}
          ...
          {/* Transform Section - Image Left, Text Right */}
          <div className="grid md:grid-cols-2 gap-8 items-center">
            {/* Image on the Left */}
            <div className="relative">
